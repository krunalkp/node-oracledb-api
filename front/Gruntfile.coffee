...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    watch:
      ...
      copy:
        files: ['<%= config.app %>/scripts/**/*.js', '<%= config.pub %>/images/**/*','<%= config.pub %>/fonts/**/*']
  ...
  grunt.registerTask 'default', ['jade', 'coffee', 'sass', 'copy']
  grunt.registerTask 'serve', ['default', 'connect', 'open:dev', 'watch']
